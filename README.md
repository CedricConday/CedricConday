...
| [cp-app](https://github.com/CedricConday/cp-app) | Native shell around an existing website that rotates profile photos upright on-device before upload. Expo / React Native. |
| [exif-orientation-php](https://github.com/CedricConday/exif-orientation-php) | Rotates JPEGs by their EXIF orientation field and strips the metadata. No dependencies beyond ext-gd. |
